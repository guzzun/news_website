                ...
                <div class="content_inner">
                    ...
                    <div class="news">
                        ...
                        <div class="post">
                            ...
                            // $key_word = $_POST['search'];
                            $sql = 'SELECT * FROM articles WHERE titlu LIKE "%'.$key_word.'%"';
                            $search_results = mysqli_query($conn,$sql) or die(mysqli_error($conn));
                            if(mysqli_num_rows($search_results) > 0)
                                while($row = mysqli_fetch_assoc($search_results))
                                    ...
                                    ';
                                        ...
                                        echo "There are no articles that contain the word: $key_word";
                                ?>
                            </div> <!-- ./post -->

                        <!-- right_block -->
                        <?php include "parts/right_block_article.php"; ?>
